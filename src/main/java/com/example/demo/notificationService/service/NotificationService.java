package com.example.demo.notificationService.service;

import com.example.demo.notificationService.dto.NotificationRequestDto;
import com.example.demo.notificationService.dto.SubscriptionRequestDto;
...
public class NotificationService {
    ...
    private void initialize() {
        try {
            ...
            System.out.print("Create FirebaseApp Error" + e);
        }
    }
    ...
    public void subscribeToTopic(SubscriptionRequestDto subscriptionRequestDto) {
        try {
            ...
            System.out.print("Firebase subscribe to topic fail"+ e);
        }
    }
    ...
    public void unsubscribeFromTopic(SubscriptionRequestDto subscriptionRequestDto) {
        try {
            ...
            System.out.print("Firebase unsubscribe from topic fail"+ e);
        }
    }
    ...
    public String sendPnsToDevice(NotificationRequestDto notificationRequestDto) {
        ...
        try {
            ...
            System.out.print("Fail to send firebase notification" + e);
        }
